...
@WebServlet("/SelectSpinKcnusServlet")
public class SelectSpinKcnusServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//È¥µ÷ÓÃdao²ã
				...
				request.getRequestDispatcher("UpSpinKcnum.jsp").forward(request, response);
	}
